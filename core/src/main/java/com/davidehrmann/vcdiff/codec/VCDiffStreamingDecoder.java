...
public interface VCDiffStreamingDecoder {
     ...
     * @throws IOException
     */
    void DecodeChunk(byte[] data, int offset, int length, OutputStream output_string) throws IOException;

    void DecodeChunk(byte[] data, OutputStream output_string) throws IOException;
