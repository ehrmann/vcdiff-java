...
public class VCDiffStandardDecoderTest extends VCDiffDecoderTest {
    ...
    public void DecodeHeaderOnly() throws Exception {
        ...
        assertTrue(decoder_.DecodeChunk(delta_file_header_, 0, delta_file_header_.length, output_));
